    ...
    <Form>
      <Form.Item label="Number of Transactions">
        <Input
          type="number"
          onChange={(e) =>
            setState({ ...state, numTransactions: parseInt(e.target.value) })
          }
        />
      </Form.Item>
      <Form.Item label="Number of Data Files">
        <Input
          type="number"
          onChange={(e) =>
            setState({ ...state, numDataFiles: parseInt(e.target.value) })
          }
        />
      </Form.Item>
      <Form.Item label="Number of Data Functions">
        <Input
          type="number"
          onChange={(e) =>
            setState({ ...state, numDataFunctions: parseInt(e.target.value) })
          }
        />
      </Form.Item>
